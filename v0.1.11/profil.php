...
<body>
	...
	<div class="profil-header">
		...
		<div class="modify-header">
			<form action="#" method="POST">
				<label for="modify-header-label">Changer l'image de fond</label>
		...
		<div class="modify-profil-img">
			<form action="#" method="POST">
				<p>Changer l'image de Profil</p>
				<label for="modify-profil-img-label">Sélectionner un fichier</label>
				<input type="file" id="modify-profil-img-label" class="modify-profil-img-file dn">
				<input type="submit" value="Enregistrer" class="button button-green modify-profil-img-submit">
			</form>
		</div>
	</div>
	<div class="edit-profil-band">
		<ul class="profil-top-menu">
			...
			<li id="posts"><i class="fa fa-paper-plane" aria-hidden="true"></i> Posts</li>
			<li id="relations"><i class="fa fa-users" aria-hidden="true"></i> Relations</li>
			<li id="follow"><i class="fa fa-building" aria-hidden="true"></i> Abonnements</li>
			<li id="medias"><i class="fa fa-picture-o" aria-hidden="true"></i> Medias</li>
		</ul>
		<a href="#" class="button button-reverse edit-profil">Editer le profil</a>
		<div class="clear"></div>
	</div>
	<div class="main toggle profil-main">
					...
					<ul>
						<li>
							<div class="experience-bloc">
								<h5>Direceteur recherche et développement</h5>
		...
		<div class="profil-content profil-content-posts">
			<div class="profil-info-header">
				<h2>Posts de <span>Tom Amount</span></h2>
			</div>	
		...
		<div class="profil-content profil-content-relations">
			<div class="profil-info-header">
				<h2>Relations de <span>Tom Amount</span></h2>
			</div>
		</div>
		<div class="profil-content profil-content-follow">
			<div class="profil-info-header">
				<h2>Abonnements de <span>Tom Amount</span></h2>
			</div>
		</div>
		<div class="profil-content profil-content-medias">
			<div class="profil-info-header">
				<h2>Medias de <span>Tom Amount</span></h2>
			</div>
			<div class="profil-bloc">
